...
// // Importar rutas
// import appVersionRoutes from './routes/appVersions.routes.js';
// import pushNotificationRoutes from './routes/pushNotifications.routes.js'; // Nueva ruta
...
// app.use('/api/push-notifications', pushNotificationRoutes);  // Nueva ruta
